...
This project is a prototype to demonstrate the feasibility of a grading system. There will be users of this system: System Administrators, Academic Administrators, Administrative Assistants, Instructors,  and TA/TM markers. 
Roles:
-	The System Administrator is responsible for the creation and management of accounts, program installation, and system backups/restores. The System Admin also manages the system log, which records all activities done by the grading system.
-	The Academic Administrator is responsible for overseeing the grading system and changing grades in the case of a grade dispute, if necessary. The Academic Admin also manages the Academic Log, which records all grading changes in the system.
-	The Administrative Assistant is responsible for the creation of courses (including the copying and deletion of courses)
-	The Instructor is responsible for the creation of management of activities within the courses they are teaching. They are also responsible for the management if students, student groups, and assigning TAs to assignments and student groups. The instructor may also grade activities within their course.
-	The TA/TM markers are the primary graders for the assignments and students assigned to them by the Instructor of the course
...
\begin{tabular}{c c p{2in}}
  Member & Name & Info \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.7]{../../images/groupPhotos/metroid}}}
  & Graeme Smith
  &
  \begin{itemize}
    \item gds3@sfu.ca
  ...
  \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.07]{../../images/groupPhotos/Colin}}}
  & Colin Woodbury
  & \begin{itemize}
  ...
  & \begin{itemize}
    ...
    \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.3]{../../images/groupPhotos/Chazz}}}
  & Chazz Young
  & \begin{itemize}
      \item chazzy@sfu.ca
    ...
    \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.8]{../../images/groupPhotos/Jordan}}}
  & Jordan Toering
  & \begin{itemize}
...
\begin{tabular}{c c p{2in}}
  Member & Name & Info \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.2]{../../images/groupPhotos/MarkusB}}}
  & Markus Balaski
  & \begin{itemize}
    ...
    \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.45]{../../images/groupPhotos/Ian}}}
  & Ian Pun
  & \begin{itemize}
      \item itpun@sfu.ca
