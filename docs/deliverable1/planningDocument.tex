...
\begin{center}
  \begin{tabular}{| c | c | c | l |}
    ...
    \hline
    1.0 & \today & Markus B. & Planning Document Created.\\
    & & Graeme S. & \\
    & & Jordan Toering & \\
    & & Stephen L. & \\
    & & Ian P. & \\
...
\subsection{User Specification Change}
...
\begin{tabular}{c c p{2in}}
  Member & Name & Info \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.125]{../../images/groupPhotos/Graeme}}}
  & Graeme Smith
  &
  \begin{itemize}
    \item gds3@sfu.ca
  ...
  \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.09]{../../images/groupPhotos/Colin}}}
  & Colin Woodbury
  & \begin{itemize}
    ...
    \end{itemize} \\
  \hline
  {\raisebox{-.8\height}{\includegraphics[scale=0.05]{../../images/groupPhotos/Stephen}}}
  & Stephen Laboucane
  & \begin{itemize}
