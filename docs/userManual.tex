...
\begin{enumerate}
  ...
  \item The following screen will be shown.  Select the course that you wish
    to do marking for from the drop-down list, then press Ok.
    \begin{center} 
  ...
  \item The following screen will be shown.  Students are listed down the left
    ...
    wish to mark for, and select the corresponding activity, then press Ok.
  \begin{center} 
...
\begin{itemize}
  ...
  \item Restore Database
    ...
    restore the database to. It will then prompt a second time to confirm the
    restoration of the system to that backup.
