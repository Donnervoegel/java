...
they will be sent to the landing page, and otherwise an error will be shown informing the user their username or password was incorrect. If the user makes five unsuccessful attempts to log in, the user will be blocked.\\
...
\label{landPg}\\
The Landing Page is shown to all users of the system following a successful login.  The Tasks box shows actions that each user can do.  It does not show actions the user cannot do. The above represents what an Instructor would see upon logging in.
