...
\item The following screen will be shown. Press the "Create a Course" button.

!!!!!!!!!!!!!! Need landing page for admin assistant !!!!!!!!!!!!!
...
!!!!!!!!!! ADD NEWTACOURSES.PNG HERE !!!!!!!!!!!!!!!!!

	Here, we can enter an additional TA/Marker following the same steps. To remove an additional TA due to input error, you can press the "-" button next to the newest TA/Marker field to remove it.

	\item Enter the Course Start Date and Course End Date first by the year, month, then day seperated by a slash (YY/DD/MM). An example input would be 2014/03/07, translating to March 7, 2014.
	\item To input the student list, press the "choose file" button and a pop-up will appear asking for you to locate the .csv file containing the current student list for the designated course.
	\end{enumerate}

\item once all the information has been entered in correctly, Click "Submit" to finish creating the course.
...
\begin{enumerate}
	\item Log in to the system as an Administrator Assistant
	\item The following menu screen will be shown. Select the "Modify A Course" button
