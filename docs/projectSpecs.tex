...
\author{Markus Balaski \\ Stephen Laboucane \\ Ian Pun \\ Graeme Smith \\ Jordan Toering \\ Colin Woodbury \\ Chazz Young}
\date{\today}
\maketitle
\clearpage
% ------------------
...
\begin{center}
  \begin{tabular}{| c | c | c | l |}
    ...
    & & Stephen Laboucane & \\
    & & Ian Pun & \\
    0.0 & 2014 Jan 24(Fri) & Graeme Smith & Cration of Document \\
    & & Jordan Toering & \\
    & & Colin Woodbury & \\
    & & Chazz Young & \\
    \hline
...
\end{itemize}
\subsubsection{Existing Account Modification \label{Account Mod}}
The System Admin can:
\begin{itemize}
  \item Change permissions or block accounts that pose security risks.
  \item Reset passwords for users with forgotten passwords or five consecutive failed logins.
\end{itemize}
\subsubsection{System Backup and Restoration}
The System Administrator maintains an archive of the system. 
\begin{itemize}
  \item The System Administrator will archive the system at the end of overy semester.
  \item The System Administrator will restore the system to the required archive as necessary.
  \item The System will purge any archives that are greater than five years old.
\end{itemize}
\subsubsection{System and Academic Logs}
The System Administrator is responsible for the maintenance and archiving of logs. \\
See section \ref{logs} on page \pageref{logs}
...
The Academic Admin does not have any jurisdiction over the role of System
Administrator. The Academic Administrator role assumes all functions of and can
change/update any material provided by the following users:
\begin{itemize}
  \item Assistant Academic Administrator in section \ref{AsAcAdmin}, page
    \pageref{AsAcAdmin}.
  \item Instructors  in section \ref{Instructor}, page \pageref{Instructor}.
  \item TA/TMs in section \ref{Marker}, page \pageref{Marker}.
\end{itemize}
...
\section{Account Creation/Modification - Requirement \ref{Account Creation} and \ref{Account Mod}}

\begin{center}
  \begin{tabular}{| c | c | c | l |}
    \hline
    Data Displayed &  Data Submitted & Data Returned/Saved \\
    \hline
    & The account owner's name & The account owner's name \\
    (blank fields & The account owner's employee ID & The account owner's employee ID \\
    & The account owner's account type & The account owner's account type \\
