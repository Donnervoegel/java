...
\begin{itemize}
	\item The user will create an activity (assignment) by including all activity
		details for that activity from the list above in section \ref{ActivityManagement}.
	\item In the case of a coding assignment, the user will enter additional details
		listed in the testing portion of the above list.
\end{itemize}
