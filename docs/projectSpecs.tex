...
\begin{itemize}
  \item Assistant Academic Administrator in section \ref{AsAcAdmin} on page
    \pageref{AsAcAdmin}.
...
Users are granted five(5) attempts to log in successfully.  If they incorrectly
...
the use back to the course management system for other options.
\subsection{Description}
